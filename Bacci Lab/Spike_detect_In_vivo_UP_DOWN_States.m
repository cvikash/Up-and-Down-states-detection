...
[bLow,aLow] = ellip(2,0.1,40,Fp/(0.5*Fs));  % A lowpass filter at the cutoff frequncy 500 Hz
...
phaseMethod = 'hilbert';
bands = {'1-2','2-4','3-5','1-4'};
theta = [3.1048,3.0931,3.0941,2.9925];
nSTD_UP = 4;
nSTD_DOWN = 4;
fHigh = [20, 100];
combFlag = 0;
...
[UP_states_DET, DOWN_states_DET] = UP_DOWN_DET_detectStates(S_comb, thUP, thDOWN, minInterv, minDuration); %Detect UP and DOWN states
